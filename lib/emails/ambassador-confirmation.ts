...
export function ambassadorConfirmationEmail(fullName: string) {
  ...
  return {
    ...
    html: emailLayout(`
      ...
      <p style="margin:0 0 16px;">Ambassadors help represent ValGo on campus, drive sign-ups, and earn referral commissions, plus exclusive merch, internship opportunities, and real leadership experience along the way.</p>

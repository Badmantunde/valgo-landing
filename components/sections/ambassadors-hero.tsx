...
import { GraduationCap, ArrowRight, Award, Gift, DollarSign, Users } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          >
            ...
            >
              ...
              CAMPUS LEADERSHIP &amp; AMBASSADOR PROGRAM
            </Badge>
            ...
            <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-[3.75rem] font-black uppercase tracking-tight leading-[1.04] text-white">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-blue-100 to-white">
                Earn Free Meals &amp; Perks.
              </span>
            </h1>

            <p className="mt-5 text-base sm:text-lg text-white/75 leading-relaxed max-w-xl mx-auto lg:mx-0 font-normal">
              Become the face of ValGo on your campus. Host hostel food drops, earn referral rewards, enjoy free weekly meals, and build real startup experience for your CV.
            </p>
          ...
          {/* Right Column: Hero Image & Floating Ambassador VIP Pass Card */}
          <motion.div
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/20 shadow-2xl bg-[#0a1628]">
              ...
              <div className="p-5 bg-white/[0.04] backdrop-blur-md">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-base font-bold text-white">Student Ambassador Community</h3>
                    <p className="text-xs text-white/60 mt-0.5">Faculty &amp; Hall Leads &bull; OOU Ago Iwoye</p>
                  </div>
                  <div className="text-right">
                    <span className="text-xs font-black text-emerald-400">Free Weekly Meals</span>
                    <p className="text-[10px] text-white/40">VIP Merch Kit Included</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Floating Ambassador Pass Pill Card */}
            <motion.div
              animate={{ y: [0, -6, 0] }}
            ...
            >
              <div className="flex items-center justify-between pb-2 border-b border-white/10 mb-2">
                ...
                <span className="text-[9px] font-mono text-blue-300 font-bold">OOU ALPHA</span>
              </div>
              <span className="block text-2xl sm:text-3xl font-black text-white tabular-nums tracking-tight">
                Weekly Meal Credits
              </span>
              <p className="text-[11px] text-white/60 mt-0.5">
                Plus referral bonuses, merch &amp; mentorship
              </p>
            </motion.div>
          </motion.div>
        </div>
